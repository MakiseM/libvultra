...
#include "mesh_scene.glsl"
    ...
    defined(VULTRA_DECLARE_GENERAL_GAUSSIAN_SPLAT_ECSPT_COUNTER_BUFFER) || \
    defined(VULTRA_DECLARE_GENERAL_GAUSSIAN_SPLAT_COVERAGE_TEXTURE_BUFFER) || \
    ...
    defined(VULTRA_DECLARE_GENERAL_GAUSSIAN_SPLAT_TEMPORAL_STATE_BUFFER_READWRITE) || \
