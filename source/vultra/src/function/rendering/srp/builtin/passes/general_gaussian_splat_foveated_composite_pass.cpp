...
namespace vultra
{
    namespace
    {
        ...
        struct GeneralGaussianSplatFoveatedCompositePushConstants
        {
            ...
            glm::vec4 foveatedParams {1.0f, 1.0f, 8.0f, 1.0f};
        };
                                                                          ...
                                                                          FrameGraphResource      baseColor)
    {
        ...
        auto data = ctx.fg.addCallbackPass<PassData>(
            ...
            [this, useMultiview, useBase, pushConstants](
                ...
                const auto* pipeline =
                    getPipeline(rhi::getColorFormat(rc.framebufferInfo().value(), 0), useMultiview, useBase);
                if (!pipeline)
                    return;
        ...
        const bool             useBase) const
    {
        ...
        auto fragmentShader = loadGeneralShader("gaussian_splat_foveated_composite.frag",
